...
export default function BookingConfirmationPage() {
  ...
  useEffect(() => {
    const fetchDict = async () => {
      ...
      // Assuming translations for this page are under a key like "BookingConfirmationPage"
      setT(dict.BookingConfirmationPage || {
  ...
  if (Object.keys(t).length === 0) {
    return <div>Loading translations...</div>; // Or a proper loader
  }
