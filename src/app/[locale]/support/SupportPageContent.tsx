...
export default function SupportPageContent({ t, locale }: SupportPageContentProps) {

  const createFaqItems = (translations: any) => [
    {
      question: translations.faqQ1 || "How do I post a job?",
      answer: translations.faqA1 || "Navigate to 'Post a Job'. Fill details. More details, better matches!"
    },
    {
      question: translations.faqQ2 || "How do I find a service provider?",
      answer: translations.faqA2 || "Go to 'Browse Services'. Search and filter to find professionals."
    },
    {
      question: translations.faqQ3 || "Is my payment secure?",
      answer: translations.faqA3 || "Currently COD. Online payment is simulated. Secure gateways in live system."
    },
    {
      question: translations.faqQ4 || "How to become a service provider?",
      answer: translations.faqA4 || "Click 'Join as Pro'. Register. After verification, profile listed."
    },
  ];
      ...
      <Card className="shadow-xl bg-card">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-muted-foreground max-w-xl mx-auto">
            {t.helpIntro || "We're here to help! Find answers or reach out."}
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      <Card className="bg-background shadow-lg">
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            {t.contactUsDescription || "Can't find an answer? Get in touch."}
          </CardDescription>
        </CardHeader>
