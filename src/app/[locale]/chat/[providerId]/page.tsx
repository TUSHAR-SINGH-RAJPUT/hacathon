...
export default function ChatPage() {
  ...
  useEffect(() => {
    const fetchDict = async () => {
      ...
      // Assuming translations for this page are under a key like "ChatPage"
      setT(dict.ChatPage || {
  ...
  useEffect(() => {
    if (providerId && Object.keys(t).length > 0) { // Ensure translations are loaded before setting initial message
